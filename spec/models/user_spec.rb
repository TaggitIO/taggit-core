  ...
  context '#sync_with_github!' do
    ...
    before do
      ...
      stub_request(:get, "https://api.github.com/user/orgs").
        with(:headers => {'Accept'=>'application/vnd.github.v3+json', 'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3', 'User-Agent'=>"Octokit Ruby Gem #{Octokit::VERSION}"}).
